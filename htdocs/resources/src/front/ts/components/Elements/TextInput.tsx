...
class TextInput extends React.Component<IProps, IState> {
  ...
  render() {
    ...
    inputProps.type =
      this.props.controlType === undefined ? "text" : this.props.controlType;
    inputProps.className = this.state.isInvalid;
    inputProps.name =
      this.props.name === undefined ? this.props.identity : this.props.name;
    inputProps.autoComplete =
      this.props.autoComplete === undefined
        ? this.props.identity
        : this.props.autoComplete;
    inputProps.required =
      this.props.required === undefined ? true : this.props.required;

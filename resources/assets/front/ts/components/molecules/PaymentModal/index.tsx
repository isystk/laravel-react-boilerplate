...
const PaymentModal = ({ isOpen, handleClose, appRoot, amount }: Props) => {
    ...
    const handlePayment = async (values) => {
        ...
        // 決算処理を行う
        await appRoot.cart.payment(stripe, elements, values);
        // 完了画面を表示する
                ...
                >
                    {({ values, errors }) => (
                        <Form>
                            ...
                            <div className="mt-3">
                                <label className="font-bold">カード番号 <span className="text-red-600 text-sm">(テストデータ：5555555555554444)</span></label>

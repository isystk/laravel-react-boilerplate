        ...
        <div class="card-body">
            ...
            >
                ...
                <div class="form-group">
                    <label for="name" class="col-form-label">{{ __('stock.Name') }}</label>
                    <div class="col-sm-8">
                        <input
                            type="text"
                            name="name"
                ...
                <div class="form-group">
                    <label for="detail" class="col-form-label">{{ __('stock.Detail') }}</label>
                    <div class="col-sm-8">
                        <textarea
                            name="detail"
                            id="detail"
                ...
                <div class="form-group">
                    <label for="price" class="col-form-label">{{ __('stock.Price') }}</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label for="quantity" class="col-form-label">{{ __('stock.Quantity') }}</label>
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input
                                type="number"
